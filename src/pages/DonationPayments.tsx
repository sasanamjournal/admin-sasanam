...
export default function DonationPayments() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-serif font-black text-body">Donation Payments</h1>
        <p className="text-sm text-muted mt-1">All donation payment transactions with donor messages</p>
      </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-primary/10 bg-cream/50">
                    ...
                    <th className="px-4 py-3 text-left text-2xs font-black uppercase tracking-widest text-primary/70">Message</th>
